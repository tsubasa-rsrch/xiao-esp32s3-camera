/*
 * 翼の全感覚 v1.1 - カメラ＋マイク＋SD＋WiFiストリーミング
 * Xiao ESP32S3 Sense用
 * エンドポイント:
 *   /        - ステータス画面
...
// 静的IPアドレス設定
IPAddress staticIP(192, 168, 1, 100);  // Change to your desired static IP
